...
def build(ctx, *, qr, place_resolver=None) -> dict[str, PackTool]:
    """The ledger's 11 tools, closed over one turn's ``ctx``.
            ...
            if pending:
                ...
                for d in pending:
                    ...
                    if att.get("type") == "payment_draft":
                        ...
                        names = _names_for(s, ctx.space_id, [att.get("payer_member_id")])
                        summaries.append({
